      ...
      <div class="section text-center" style="padding-bottom: 5px;padding-top: 5px;">
        <div class="team" style="margin-top: 5px;">
          <div class="row">
            ...
            <div class="col-sm-4">
              <div class="alert alert-danger" style="border-radius: 10px;padding-right: 10px;padding-left: 10px;margin-left: 10px;margin-right: 10px;background-color: #019345;">
                <div class="container-fluid">
                  <h4 class="container-fluid text-left">Codigo del pedido #{{ $cart->id }}</h4>

                  @if($cart->status == "pendiente")
                  <div class="alert alert-warning text-left" style="border-radius: 10px;align-items: center;padding-top: 5px;padding-bottom: 5px;background-color: #CF2734;">
                  ...
                  <div class="alert alert-warning" style="border-radius: 10px;background-color: #CF2734;">
